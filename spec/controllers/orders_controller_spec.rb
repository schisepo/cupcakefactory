...
describe OrdersController do
  ...
  describe "index" do
    before do
      Order.create!(name: 'Baked Potato w/ Cheese')
      Order.create!(name: 'Garlic Mashed Potatoes')
      Order.create!(name: 'Potatoes Au Gratin')
      Order.create!(name: 'Baked Brussel Sprouts')
